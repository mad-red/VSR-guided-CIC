...
# load the model
if opt.eval:
    re_sort_net.load_state_dict(torch.load(os.path.join('saved_model/flickr_tr', 'model-tr.pth')))
...
for e in range(start_epoch, start_epoch+100):
    ...
    save_checkpoint(re_sort_net, infos, optimizer, append='tr')
